            ...
            <ul class="tiles">
                <li class="tiles-list">
                    <div class="tiles-upper-content">
                        ...
                        <p>Take advantage of the Excite platform to for your products and services right to your buyers
</p>
                    </div>
                ...
                <li class="tiles-list">
                    <div class="tiles-upper-content">
                        ...
                        <p>Leverage the influencer Marketing on the Excite platform to boost your products and services</p>
                    </div>
                <div class="tiles-upper-lower">
                        <p>Learn more -></p>
                </div></li>

                <li class="tiles-list"><div class="tiles-upper-content">
                <img src="https://image.freepik.com/free-vector/couple-professionals-analyzing-graphs_74855-4393.jpg" className="page-img" />

                    <h3>Enterprise Solutions</h3>
                        <p>Register your business access loans to start-up your business.</p>
                    </div>
                    <div class="tiles-upper-lower">
                        <p>Learn more -></p>
                    </div>
