    ...
    //    }
      ...
      render(){
          ...
          return(
            ...
            <Nav />
                  ...
                  <div className="fitter">
                    ...
                    <div className="left">
                        <h1>Welcome to Exite</h1>

                          <p>
                            Trade with Excite, quicker and more efficiently on this online platform where you can offer your products
                            <button className="main-button">Register Now</button>
                          </p>
                      </div>
                      <div className="right">
                          <img src className="img-f" />
                      </div>
                    </div>
                  </div>
        ...
        <section class="shop">
           ...
           className="s-text-products"><b>Latest Products</b></h1>
