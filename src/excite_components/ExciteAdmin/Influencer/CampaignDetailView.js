...
import AdminCampaignDetailsTable from './Tables/CampaignDetailTable'
...
class adminCampaignDetail extends Component{
    ...
    <div className="">
            <div className="">
            <AdminCampaignDetailsTable  token={this.props.token} data = {data} />
            </div>
    </div>
</div>
...
<div className="fitter">
    <div className="page-grid">
        ...
        <Descriptions title="Campaign Data" bordered>
