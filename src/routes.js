...
import GeoSearchProducts from './excite_components/General/GeoSearch'
...
import NewHome from './excite_components/General/newHome/home'
// import MainHomePage from './excite_components/General/homepage/main'

//Test Landing Page
import featureHomeContent from './excite_components/General/fHomepage/main'
import SearchPage from './excite_components/General/fHomepage/sections/search-page'
...
// New Dashboard
import MainDash from './excite_components/Private/main'
import UserItems from './excite_components/Private/Uploads/user_items'
import CampaignTwo from './excite_components/Private/InfluencerMarketing/new_campaign'
//Dump
...
const PageRouter= () => (
    ...
    <Route exact path="/tte" component={NewHome} />{" "}
    ...
    <Route exact path = "/admin-cac-detail/:CACID" component ={CacAdminBusinessDetails} /> {""}

    <Route exact path = "/admin-sme-loans-list/" component ={AdminLoanListView} /> {""}
    <Route exact path = "/admin-sme-loans-detail/:LoanID" component ={AdminLoanDDetailsView} /> {""}
    ...
    <Route exact path="/results/produts/:roleType/:Location" component={GeoSearchProducts} />{" "}
    ...
    <Route exact path = "/create/portal/home_applicances/:categoryID/" component = {HomeApp_Item_Create} /> {" "}
    <Route exact path = "/create/portal/vehicles/:categoryID/" component = {Vehicles_Item_Create} /> {" "}
    <Route exact path = "/create/portal/phones/:categoryID/" component = {Phone_Item_Create} /> {" "}
    ...
    <Route exact path = "/vendorProducts/:vendorProductId/" component = {User_Post_Conent} />{""}
    ...
    {/* <Route exact path = "/main" component ={MainHomePage} /> {""} */}

    {/*Influencer Marketing ends here */}

     {/*Email Builder starts here */}
    <Route exact path = "/websitebuilder" component ={createSection} /> {""}
    <Route exact path = "/create-website-portal" component ={webCreatePortal} /> {""}

    <Route exact path = "/preview/:vendorName/:pageID/" component ={buyerTemplateView} /> {""}
    <Route exact path = "/vendor-template/:pageID" component ={showcaseVendorTemp} /> {""}
    ...
    <Route exact path = "/business-data/:CACID" component ={CacBusinessDetails} /> {""}
    ...
    <Route exact path="/vendor-user-uploads" component={UserItems} />
    <Route exact path="/vendor-campaign" component={CampaignTwo} />
